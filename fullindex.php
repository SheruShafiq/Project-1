  ...
  <div class="coinlist" id="coinlist">
    <div class="listcontent">
      ...
      for ($i = 0; $i <= 99; $i++) {
        ...
        ${"per_24usdc$i"} = ${"usdc$i"}->CHANGEPCT24HOUR;
        ${"ico$i"} = ${"usdc$i"}->IMAGEURL;
        ${"mc_usdc$i"} = substr(${"mc_usdc$i"}, 0, 5);
      ...
      echo "<div id='myID' class='bottomMenu hide'>";
      echo "<table>";
      for ($i = 9, $c = 10; $i < 30; $c++, $i++) {
        echo "<tr class='listofcoins'>";
        echo "<td id='boxes'>";
        echo "<h2 class='midba'>   $c</h2>";
        echo "</td>";
...
<script>myID = document.getElementById("myID");
